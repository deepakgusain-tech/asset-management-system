...
export const requestQuotationSchema = z.object({
  ...
  requirement: z.string().trim().min(10, "Requirement is required"),
  status: z.enum(["DRAFT", "SENT"]).default("DRAFT"),
  createdAt: z.date().nullable().optional(),
  updatedAt: z.date().nullable().optional(),
});

// 1️. Attachment schema first
export const vendorQuotationAttachmentSchema = z.object({
  id: z.string().optional(),
  itemId: z.string(),
  fileName: z.string().min(1, "File name is required"),
  fileUrl: z.string().min(1, "File URL is required"),
  fileType: z.enum(["IMAGE", "PDF", "DOC"]),
...
export const vendorQuotationItemSchema = z.object({
  ...
  discount: z.number().min(0).nullable().optional().default(0),
  ...
  attachments: z.array(vendorQuotationAttachmentSchema).optional(),

  createdAt: z.date().nullable().optional(),
  updatedAt: z.date().nullable().optional(),
});

// 3️. Quotation schema last
export const vendorQuotationSchema = z.object({
  ...
  items: z.array(vendorQuotationItemSchema).optional(),
