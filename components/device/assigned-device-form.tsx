...
import { createAssignedDevice, updateAssingedDevice } from '@/lib/actions/device-assigned-action';

const DeviceAssignedForm = ({ data, update = false, devices, employees }: { data?: DeviceAssigned, update: boolean, devices: Device[], employees: Employee[] }) => {
    ...
    const onSubmit: SubmitHandler<z.infer<typeof deviceAssignedSchema>> = async (values: any) => {
                    ...
                    <div className='flex flex-col gap-5'>
                        <FormField
                            ...
                            render={({
                                ...
                                field: ControllerRenderProps<z.infer<typeof deviceAssignedSchema>, "deviceId">
                            }) => (
                                <FormItem>
                    ...
                    <div className='flex flex-col gap-5'>
                        <FormField
                            ...
                            render={({
                                ...
                                field: ControllerRenderProps<z.infer<typeof deviceAssignedSchema>, "employeeId">
                            }) => (
                                <FormItem>
                                    <FormLabel>Category</FormLabel>
                                    <FormControl>
                    ...
                    <div className='flex flex-col gap-5'>
                        <FormField
                            ...
                            render={({
                                ...
                                field: ControllerRenderProps<z.infer<typeof deviceAssignedSchema>, "assignedDate">
                            }) => (
                                <FormItem>
                    ...
                    <div className='flex flex-col gap-5'>
                        <FormField
                            ...
                            render={({
                                ...
                                field: ControllerRenderProps<z.infer<typeof deviceAssignedSchema>, "returnedDate">
                            }) => (
                                <FormItem>
                    ...
                    <div className='flex flex-col gap-5'>
                        <FormField
                            ...
                            render={({
                                ...
                                field: ControllerRenderProps<z.infer<typeof deviceAssignedSchema>, "status">
                            }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                {
                                                    (Object.values(AssignedDeviceStatus)).map((status : string, index : number) => (
                ...
                <div className='flex flex-col gap-5'>
                    <FormField
                        ...
                        render={({
                            ...
                            field: ControllerRenderProps<z.infer<typeof deviceAssignedSchema>, "remarks">
                        }) => (
                            <FormItem>
                                <FormLabel>Description</FormLabel>
                                <FormControl>
                                    <Textarea rows={20} className='h-40' placeholder='Enter Remarks' {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
